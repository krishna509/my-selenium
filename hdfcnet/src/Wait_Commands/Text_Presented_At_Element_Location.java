...
public class Text_Presented_At_Element_Location {
...
//	System.out.println("true ");
	...
	WebDriverWait wait=new WebDriverWait(driver,50);
	wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("html/body/div[7]/div[3]/div/div[1]/div[5]/div[1]/div/div[3]/div/div/div[2]/span/span[1]"), Exp_res));
	System.out.println("true as we expected message as displayed");
